...
// PolicyDefinition represents a policy definition in v1alpha3 format
...
// PolicyReference represents a reference to a policy in v1alpha3 format
...
// Group represents a group with roles in v1alpha3 format
type Group struct {
	Mrn         string       `yaml:"mrn"`
	Name        string       `yaml:"name"`
	Description string       `yaml:"description"`
...
// Operation represents an operation in v1alpha3 format
...
// Mapper represents a mapper in v1alpha3 format
type Mapper struct {
	Name     string   `yaml:"name"`
	Selector []string `yaml:"selector"`
	Rego     string   `yaml:"rego"`
...
// IntermediateModel represents the intermediate v1alpha3 YAML structure
...
// LoadFromBytes loads a v1alpha3 policy domain from raw YAML bytes.
...
// Load loads a v1alpha3 policy domain from a file path.
