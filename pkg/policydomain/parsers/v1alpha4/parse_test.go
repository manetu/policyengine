...
`
	...
	// Verify roles with annotations and merge strategy
	...
	// Verify resources (v1alpha4 specific)
...
func TestExportReference(t *testing.T) {
	ref := PolicyReference{
		...
		Annotations: []Annotation{
			{Name: "level", Value: "\"high\"", Merge: "replace"},
		},
	}
...
func TestExportGroup(t *testing.T) {
	grp := Group{
		...
		Annotations: []Annotation{
			{Name: "team", Value: "\"platform\"", Merge: "append"},
		},
	}
...
func TestExportResource(t *testing.T) {
	resource := Resource{
		...
		Annotations: []Annotation{
			{Name: "classification", Value: "\"HIGH\"", Merge: "replace"},
			{Name: "audit", Value: "true"},
		},
	}
